...
\end{itemize}
The observed positive rank association ($\rho=0.50$) provides preliminary descriptive evidence of alignment between Shapley valuation and leave-one-client-out utility degradation; however, the three-client setting does not support reliable inferential claims. The measured permutation Shapley computation time (0.0561s) was comparable to LOO (0.0438s), providing descriptive evidence for the feasibility of permutation-based valuation in this three-client setting.
