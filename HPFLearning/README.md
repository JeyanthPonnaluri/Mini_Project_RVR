# HPFLearning 📦 (Hyper-Parameterized Federated Learning)

`HPFLearning` is a secure, lightweight, and mathematically rigorous Python library for **collaborative machine learning under privacy, data heterogeneity, and participation incentive constraints**.
